...
public class Question6 extends JFrame implements ActionListener
{
   ...
   public Question6 (String title)                           
   {
      super( title );
      JLabel text = new JLabel("6) For a major decision to pass in my group,");
      JLabel text1 = new JLabel("it must have the approval of each individual or the majority.");
   ...
   public void actionPerformed( ActionEvent evt)
   {
      ...
      {
         setVisible(false);
         Question7 confirm = new Question7 ("Question #7");
