...
public class AandDEM extends JFrame implements ActionListener
{
   JButton contButton ;
   ...
   public AandDEM (String title)                           
   {
      ...
      JLabel text8 = new JLabel("They do not recieve nor use advice from groupmates. One of the appropiate conditions to use this style is when you are short");
      JLabel text9 = new JLabel("on time, and your team is not really interested in completing the task. Some people think of this style as a vehicle for");
      JLabel text10 = new JLabel("yelling, using demeaning language, and leading by threats and abusive power. This is NOT the authoritarian style as it is an");
      JLabel text11 = new JLabel("abusive, unprofessional style called 'bossing around'. ");
